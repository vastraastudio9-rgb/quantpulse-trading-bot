...
REGIME_STRATEGY_MAP: Dict[str, List[str]] = {
    ...
    "RANGE_BOUND_TIGHT": ["STRADDLE_SELL", "STRANGLE_SELL", "IRON_CONDOR", "IRON_BUTTERFLY", "LONG_BUTTERFLY", "CALENDAR_SPREAD", "VRP_HARVEST"],
    "RANGE_BOUND_WIDE": ["STRANGLE_SELL", "IRON_CONDOR", "CALENDAR_SPREAD", "VRP_HARVEST"],
...
REGIME_AVOID_MAP: Dict[str, List[str]] = {
    ...
    "TRENDING_UP_VOLATILE": ["STRADDLE_SELL", "STRANGLE_SELL", "IRON_CONDOR", "IRON_BUTTERFLY", "VRP_HARVEST"],
    "TRENDING_DOWN_VOLATILE": ["STRADDLE_SELL", "STRANGLE_SELL", "IRON_CONDOR", "IRON_BUTTERFLY", "VRP_HARVEST"],
